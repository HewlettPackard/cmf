    ...
    <>
      ...
      <svg width={svg_width} height={tangled_height + textPadding * 10}>
        ...
        {tangleLayout.nodes.map(n => {
          ...
          if (n.id.startsWith('execution_name_')) {
            strokeColor = 'red';
            strokeWidth = 12;  
          ...
          return (
            <React.Fragment key={n.id}>
              ...
              <text x={n.x + labelOffset + textPadding} y={n.y - n.height / 2 - labelOffset + textPadding} style={{ pointerEvents: 'none' }}>{label}</text>
            </React.Fragment>
          );
        })}
      </svg>
...
const ArtifactExecutionTangledTree = ({ data }) => {
...
export default ArtifactExecutionTangledTree;
