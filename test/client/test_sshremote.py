...
def test_cmf_init_sshremote(cmf_server_url, ssh_user, ssh_pass, ssh_path):
    print("-------------------------------Test Case Name: cmf init local ----------------------------------")
        _=cmf.cmf_init(type="sshremote", path=ssh_path, user=ssh_user, port="22", password=ssh_password,
                      git_remote_url="https://github.comuser-hpe/experiment-repo.git", cmf_server_url=cmf_server_url)
