...
def parse_json_to_mlmd(mlmd_json, path_to_store, cmd, exec_id, backend: str ="sqllite"):
    ...
    if cmd == "push":
        ...
        data = mlmd_data
    cmf_class = cmf.Cmf(filename=path_to_store, pipeline_name=pipeline_name, is_server=True, backend=backend)
