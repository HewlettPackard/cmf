...
from cmflib.commands import artifact, metadata, init, execution, pipeline, repo, dvc, recorder

from cmflib.cli import CmfParserError

COMMANDS = [artifact, metadata, init, execution, pipeline, repo, dvc, recorder]
