...
class Cmf:
    ...
    def commit_metrics(self, metrics_name: str):
        ...
        directory_path = os.path.join(ARTIFACTS_PATH, self.execution.properties["Execution_uuid"].string_value, METRICS_PATH)
    ...
    def read_dataslice(self, name: str) -> pd.DataFrame:
        ...
        directory_path = os.path.join(ARTIFACTS_PATH, self.execution.properties["Execution_uuid"].string_value, DATASLICE_PATH)
    ...
    class DataSlice:
        ...
        def commit(self, custom_properties: t.Optional[t.Dict] = None) -> None:
            ...
            directory_path = os.path.join(ARTIFACTS_PATH, self.writer.execution.properties["Execution_uuid"].string_value, DATASLICE_PATH)
            os.makedirs(directory_path, exist_ok=True)
            custom_props = {} if custom_properties is None else custom_properties
            git_repo = git_get_repo()
