...
#,"http://127.0.0.1:80", "neo4j ","password" ,"bolt://localhost:7687")

#_=cmf.cmf_init_local("/home/user/local-storage","https://github.com/user/experiment-repo.git","http://127.0.0.1:80", "neo4j ","password" )
#,"bolt://localhost:7687")
