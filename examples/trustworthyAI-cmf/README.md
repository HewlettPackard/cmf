# This repository contains code needed to experiment Bias in Image based Automatic Gender classification using AIF360 tool and tracking of metadata through CMF (Common Metadata Framework). 
