...
def update_X_L(uncertainty, X_all, X_L, X_S_size):
    ...
    print(uncertainty_X_U)
    uncertinity = {}
    print(uncertainty_X_U.shape)
    print(uncertainty_X_U[0])
    uncertinity["median"] = str(np.median(uncertainty_X_U))
    uncertinity["mean"] = str(np.mean(uncertainty_X_U))
    print("printing uncertainity=================")
    print(uncertinity)
    print("===================================")
    print(arg[-X_S_size:])
    ...
    X_L_next.sort()
    X_U_next.sort()
    return X_L_next, X_U_next, uncertinity
